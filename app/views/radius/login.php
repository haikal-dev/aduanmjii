		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="<?=$url?>/radiuscdn/images/logo2.png" alt="IMG">
				</div>

				<form class="login100-form validate-form" onsubmit="return login(this);">
					<span class="login100-form-title">
						RADIUS <span style="font-size: 0.5em;"><?=$radius_ver?></span>
					</span>
...
<!--===============================================================================================-->
	<script src="<?=$url?>/radiuscdn/js/main.js"></script>
